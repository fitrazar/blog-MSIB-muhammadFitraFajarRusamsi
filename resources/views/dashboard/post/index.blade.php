@section('title', 'Data Postingan / Artikel')
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, full, meta) {
                                return `<img src="{{ asset('storage/post/${full.image}') }}" class="w-14 h-14" />`
                            },
                            orderable: false,
                            searchable: false,
                        },
